...
<CardGroup>
  <Card icon="terminal" title="Runtime" href="/runtime">
    Bun runtime for executing JavaScript/TypeScript
  </Card>
  <Card icon="file-code" title="Runtime - TypeScript" href="/runtime/typescript">
    TypeScript support in Bun runtime
  </Card>
  <Card icon="flask-conical" title="Test Runner" href="/test">
    Jest-compatible, TypeScript-first tests
  </Card>
  <Card icon="package" title="Package Manager - Install" href="/pm/cli/install">
    Install packages with bun install
  </Card>
  <Card icon="boxes" title="Bundler" href="/bundler">
    Bundle TypeScript, JSX, React & CSS
  </Card>
  <Card icon="loader" title="Bundler - Loaders" href="/bundler/loaders">
    Built-in loaders for file types
  </Card>
  <Card icon="file-binary" title="Bundler - Executables" href="/bundler/executables">
    Create single-file executables
  </Card>
  <Card icon="puzzle" title="Bundler - Plugins" href="/bundler/plugins">
    Plugin API for custom loaders
  </Card>
</CardGroup>

### Runtime

- [HTTP Server](/runtime/http-server.md) - Bun.serve for high-performance HTTP servers
- [WebSockets](/runtime/websockets.md) - Server-side WebSockets with pub/sub
- [Fetch](/runtime/fetch.md) - HTTP client with S3, file, and proxy support
- [Redis](/runtime/redis.md) - Native Redis client with Promise-based API
- [SQL](/runtime/sql.md) - SQL database bindings for PostgreSQL, MySQL, SQLite
- [Workers](/runtime/workers.md) - Create and communicate with worker threads
- [File I/O](/runtime/file-io.md) - Read and write files with Bun.file() and Bun.write()
- [Environment Variables](/runtime/environment-variables.md) - .env file support and configuration
- [Spawn](/runtime/child-process.md) - Spawn child processes with Bun.spawn

### Package Manager

- [bun add](/pm/cli/add) - Add packages to your project
- [bun remove](/pm/cli/remove) - Remove dependencies from your project
- [bun update](/pm/cli/update) - Update dependencies to latest versions
- [bun outdated](/pm/cli/outdated) - Check for outdated dependencies
- [bun audit](/pm/cli/audit) - Check for security vulnerabilities
