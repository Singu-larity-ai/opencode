...
source: https://casdoor.org/docs/organization/overview
description: Organizations are the primary unit in Casdoor for managing users and applications with SSO, password algorithms, and avatar storage.
---
...
## Password Storage Algorithms[​](#password-storage-algorithms "Direct link to Password Storage Algorithms")
...
## Password Salt Configuration[​](#password-salt-configuration "Direct link to Password Salt Configuration")
...
**Recommendation:** Use per-user salt for new deployments to strengthen protection against rainbow-table attacks.

## Permanent avatar storage[​](#permanent-avatar-storage "Direct link to Permanent avatar storage")
...
## Use email as username[​](#use-email-as-username "Direct link to Use email as username")
