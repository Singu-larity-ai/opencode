...
source: https://casdoor.org/docs/permission/overview
description: Permission management in Casdoor powered by Casbin with models, policies, and role-based access control.
---
...
## Casbin concepts[​](#casbin-concepts "Direct link to Casbin concepts")
...
## Configuring permissions in Casdoor[​](#configuring-permissions-in-casdoor "Direct link to Configuring permissions in Casdoor")

### Where to configure[​](#where-to-configure "Direct link to Where to configure")
...
## Using permissions from your application[​](#using-permissions-from-your-application "Direct link to Using permissions from your application")
...
### Account item permissions[​](#account-item-permissions "Direct link to Account item permissions")
