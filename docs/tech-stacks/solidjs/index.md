---
title: Solid Docs
source: https://docs.solidjs.com/
description: Solid is a modern JavaScript framework for today's web, designed for building responsive and high-performing user interfaces with fine-grained reactivity.
---
...
- [Tutorial](https://www.solidjs.com/tutorial/introduction_basics) - Learn the basics of Solid through this interactive tutorial.
- [Templates](https://github.com/solidjs/templates) - Start your first project with a template that fits your needs.
- [Ecosystem](https://www.solidjs.com/ecosystem) - Explore the Solid ecosystem and find useful tools and libraries.
- [Contribute](https://github.com/solidjs/solid-docs-next) - Help improve Solid by contributing to the documentation.
