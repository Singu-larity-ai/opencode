export const dict = {
  ...
  "desktop.menu.help.documentation": "Singularity Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "Singularity CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
