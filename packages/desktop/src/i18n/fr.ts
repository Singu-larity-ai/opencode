export const dict = {
  ...
  "desktop.menu.help.documentation": "Documentation d'Singularity",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI Singularity est manquant. Essayez de réinstaller l'application de bureau.",
