export const dict = {
  ...
  "desktop.menu.help.documentation": "Singularity Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "Singularity CLI binary is missing. Try reinstalling the desktop app.",
