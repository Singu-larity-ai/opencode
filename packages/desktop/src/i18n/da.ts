export const dict = {
  ...
  "desktop.menu.help.documentation": "Singularity Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing": "Singularity CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
