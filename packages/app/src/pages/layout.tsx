    ...
    <div class="relative bg-background-base flex-1 min-h-0 min-w-0 flex flex-col select-none [&_input]:select-text [&_textarea]:select-text [&_[contenteditable]]:select-text">
      ...
      <div class="flex-1 min-h-0 min-w-0 flex">
        <nav
          ...
          class="hidden md:block shrink-0 z-10 relative"
          style={{ width: `${side()}px` }}
          ref={(el) => {
            setState("nav", el)
          }}
        ...
        <div class="flex-1 z-20 min-w-0 flex flex-col">
          <div class="md:hidden">
            <div
              classList={{
          ...
          <main
            class="size-full overflow-x-hidden flex flex-col items-start contain-strict border-t border-border-weak-base bg-background-base md:border-l md:rounded-tl-[12px]"
          >
