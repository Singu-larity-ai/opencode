export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Singularity",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Singularity er lastet ned. Vil du installere den og starte på nytt?",
