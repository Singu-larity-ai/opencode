export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Singularity-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Singularity-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
