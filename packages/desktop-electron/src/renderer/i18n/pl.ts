export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Singularity",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Singularity. Czy chcesz ją zainstalować i uruchomić ponownie?",
