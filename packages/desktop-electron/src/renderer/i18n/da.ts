export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Singularity",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Singularity er blevet downloadet. Vil du installere den og genstarte?",
