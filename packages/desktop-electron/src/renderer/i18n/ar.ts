export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Singularity",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من Singularity، هل ترغب في تثبيته وإعادة تشغيله؟",
