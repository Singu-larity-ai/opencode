export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Singularity",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Singularity a été téléchargée. Voulez-vous l'installer et redémarrer ?",
