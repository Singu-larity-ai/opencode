export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Singularity",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Singularity wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
