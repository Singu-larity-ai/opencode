...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>Singularity | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="Singularity terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to Singularity. Please read on to learn the rules and restrictions that govern your use of
                Singularity&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("Singularity," "we" and "us"). Your use of the Services in any
              ...
              <h2 id="what-is-opencode">What is Singularity?</h2>
              <p>
                Singularity is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the Singularity Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, Singularity enables you to
              ...
              <p>
                Singularity takes the privacy of its users very seriously. For the current Singularity Privacy Policy, please
                click here{" "}
              ...
              <h2 id="what-are-the-basics">What are the basics of using Singularity?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by Singularity;
                </li>
                <li>
              ...
              <p>
                If you use Singularity with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                Singularity. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                Singularity has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-opencode-ever-change-the-services">Will Singularity ever change the Services?</h2>
              <p>
              ...
              <p>
                Singularity is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. Singularity has the sole right to decide whether you are
              ...
              <p>
                Singularity and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (Singularity and all such
                parties together, the "Singularity Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the Singularity Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The Singularity Parties make no representations or warranties regarding
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the Singularity Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without Singularity's prior written
              ...
              <p>
                ...
                disputes and claims with Singularity and limits the manner in which you can seek relief from Singularity. Both
                you and Singularity acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, Singularity's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. Singularity will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. Singularity will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or Singularity may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                ...
                OF A JUDGE OR JURY. You and Singularity are instead choosing to have claims and disputes resolved by
                ...
                you and Singularity over whether to vacate or enforce an arbitration award, YOU AND OPENCODE WAIVE ALL
              ...
              <p>
                ...
                Singularity is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or Singularity to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and Singularity agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the Singularity may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and Singularity agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and Singularity, and
                ...
                are not an employee, agent, partner, or joint venture of Singularity, and you do not have any authority of
                any kind to bind Singularity in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and Singularity
