...
export const Flag = {
  ...
  OPENCODE_AUTHING_APP_ID: process.env["OPENCODE_AUTHING_APP_ID"],
  OPENCODE_AUTHING_APP_SECRET: process.env["OPENCODE_AUTHING_APP_SECRET"],
  OPENCODE_AUTHING_ISSUER: process.env["OPENCODE_AUTHING_ISSUER"],
