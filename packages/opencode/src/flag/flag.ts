...
export const Flag = {
  ...
  OPENCODE_CASDOOR_ENDPOINT: process.env["OPENCODE_CASDOOR_ENDPOINT"],
  OPENCODE_CASDOOR_CLIENT_ID: process.env["OPENCODE_CASDOOR_CLIENT_ID"],
  OPENCODE_CASDOOR_CLIENT_SECRET: process.env["OPENCODE_CASDOOR_CLIENT_SECRET"],
  OPENCODE_CASDOOR_ORGANIZATION: process.env["OPENCODE_CASDOOR_ORGANIZATION"],
  OPENCODE_CASDOOR_APPLICATION: process.env["OPENCODE_CASDOOR_APPLICATION"],
